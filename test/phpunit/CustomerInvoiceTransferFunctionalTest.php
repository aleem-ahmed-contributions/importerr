...
/**
 * \file    test/phpunit/CustomerInvoiceTransferFunctionalTest.php
...
/**
 * Class CustomerInvoiceTransferFunctionalTest
 *
 ...
 *
 * @package Testcustomerinvoicetransfer
 */
class CustomerInvoiceTransferFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modCustomerInvoiceTransfer')->click();
		} else {
			// Disable the module
			$this->byHref('modCustomerInvoiceTransfer')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/customerinvoicetransfer/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('customerinvoicetransfer/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/customerinvoicetransfer/admin/about.php');
		$this->authenticate();
		return $this->assertContains('customerinvoicetransfer/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('customerinvoicetransferwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCustomerInvoiceTransfer_CustomerInvoiceTransferTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCustomerInvoiceTransfer_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
